    ...
    <article class="hero-card" data-id="${esc(article.id)}" role="button" tabindex="0">
      ...
      <div class="hero-inner">
        ...
        <div class="hero-footer">
          <span class="hero-source">${esc(article.source)}${article.publishedAt ? ' · ' + formatDate(article.publishedAt) : ''}</span>
    ...
    <article class="article-card" data-id="${esc(article.id)}" role="button" tabindex="0">
      ...
      <div class="card-body">
        ...
        <div class="card-footer">
          <span class="card-source">${esc(article.source)}${article.publishedAt ? ' · ' + formatDate(article.publishedAt) : ''}</span>
